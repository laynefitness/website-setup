    ...
    <>
      ...
      <section className="page-hero">
        <div className="page-hero-grid wrap">
          ...
          <figure><div className="page-hero-media contain"><Image src="/images/layne-transformation.jpg" alt="Layne's two-stage physique transformation collage showing a reported 25-pound difference over two months" fill priority sizes="(max-width: 820px) calc(100vw - 28px), 42vw" /></div><figcaption className="proof-caption">Layne reports a 25-pound change over two months. Individual results vary.</figcaption></figure>
        </div>
      </section>
