...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = ["", "/results", "/fitness-coaching", "/nutrition", "/peptides", "/articles", "/about", "/book-a-call", "/terms", "/privacy-policy", "/cookie-policy", "/health-disclaimer", "/accessibility"];
  return [
